...
public class SlideTest {
    ...
    @Test
    public void constructor_default_shouldCreateSlideWithEmptyTitle() {
    ...
    @Test
    public void appendText_validInput_shouldAddTextItem() {
    ...
    @Test
    public void appendItem_validInput_shouldAddTextItem() {
    ...
    @Test
    public void getSlideItems_multipleAppends_shouldReturnAllItems() {
